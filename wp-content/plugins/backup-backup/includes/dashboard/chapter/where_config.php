...
<div class="mm mt mbl f20">
  <?php esc_html_e("Select all the storage options you want to use:", 'backup-backup'); ?>
</div>
...
<div class="mm60">
  <div class="mm tilo">
    ...
    <div class="tab2">
      ...
      <!-- Locally start -->
    	<div class="tab2-item d-flex jst-sb ia-center activeList">
          ...
          <img src="<?php echo esc_url( $this->get_asset('images', '002-monitor-white.svg') ); ?>" alt="logo" class="tab2-img">
          <span class="ml25">
            <span class="title_whereStored"><?php esc_html_e("Locally", 'backup-backup'); ?></span>
            <?php esc_html_e("(on this web server)", 'backup-backup'); ?>
          </span>
        </div>
    		<div class="ia-center">
    	...
    	<div class="bg_grey" id="storage-locally-row">
    		<div class="container-40 lh30 pt30 pb30">
    			<div class="d-flex">
    				<div class="w270" style="margin-top: 23px;"><span><?php esc_html_e("Backup directory path:", 'backup-backup'); ?></span></div>
    				<div>
    					<div class="w100 pos-r local-backup-path-wrapper"><input type="text" id="bmi_path_storage_default" placeholder="<?php esc_attr_e("Enter directory path", 'backup-backup'); ?>" class="input-locally_web_server" value="<?php echo esc_attr( sanitize_text_field(bmi_get_config('STORAGE::LOCAL::PATH')) ); ?>" autocomplete="off">
                <span class="backups-suffix" id="local-backups-suffix"> /backups</span>
    						<!---->
    					</div>
    					<div class="mt10"><span>
    							<?php esc_html_e("That's where your local backups will be stored. If you picked external storage this folder will also be used (to store your backup temporarily, until it is uploaded to the external storage).", 'backup-backup'); ?>
    						</span></div>
    				</div>
    			</div>
    			<div class="d-flex">
    				<div class="w270" style="margin-top: 23px;"><span><?php esc_html_e("Accessible via direct link?", 'backup-backup'); ?></span></div>
    				<div>
    					<div class="w100">
                  ...
                  <label class="container-radio ml25">
                    ...
                    <span class="checkmark-radio"></span>
    					...
    					<div class="mt10">
                <span>
    							<?php esc_html_e('Select "Yes" if you want your (manually created) backups to be available via a direct link. This makes migration from one site to another super-fast.', 'backup-backup'); ?>
    						</span>
              </div>
    				</div>
    			</div>
      ...
      <div class="tab2-item">
        ...
        <div class="bg_clock_day2">
          <img src="<?php echo esc_url( $this->get_asset('images', 'premium.svg') ); ?>" alt="crown" class="crown_img" height="30px" width="30px">
          <?php echo wp_kses_post( BMI_ALREADY_IN_PRO ); ?>
        </div>
        <div class="d-flex ia-center">
          <img src="<?php echo esc_url( $this->get_asset('images', 'one-drive.svg') ); ?>" alt="logo" class="tab2-img"> <span class="ml25 title_whereStored">OneDrive</span>
          <img src="<?php echo esc_url( $this->get_asset('images', 'premium.svg') ); ?>" alt="logo" class="crown2">
        </div>
        <div class="ia-center">
      ...
      if (has_action('bmi_pro_sftp_template')) {
          ...
          <div class="tab2-item">
              ...
              <div class="d-flex ia-center">
                <img src="<?php echo esc_url( $this->get_asset('images', 'sftp-scp.svg') ); ?>" alt="logo" class="tab2-img"> <span class="ml25 title_whereStored">SFTP</span>
                <img src="<?php echo esc_url( $this->get_asset('images', 'premium.svg') ); ?>" alt="logo" class="crown2">
              </div>
              <div class="ia-center">
                  <div class="b2 bmi-switch"><input type="checkbox" disabled="disabled" class="checkbox">
    ...
    <div class="center f16" style="margin-top: 10px;">
      <span><?php echo wp_kses_post( $askMoreESText ); ?></span>
    </div>
  </div>
</div>
