    ...
    <div class="bmi-modal-content">
      ...
      <div class="center">
        <div class="mbl cf center inline">
          ...
          <div class="left f24 bold lh50 mms"><?php esc_html_e("Invalid backup", 'backup-backup'); ?></div>
        </div>
      </div>

      <div class="center f19 regular mbl lh30">
        <?php esc_html_e("Uploaded file is not valid backup,", 'backup-backup'); ?><br>
        <?php esc_html_e("we removed the file from the server.", 'backup-backup'); ?>
      </div>
