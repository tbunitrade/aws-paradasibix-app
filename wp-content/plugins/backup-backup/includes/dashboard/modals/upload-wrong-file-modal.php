    ...
    <div class="bmi-modal-content">
      ...
      <div class="center">
        <div class="mbl cf center inline">
          ...
          <div class="left f24 bold lh50 mms"><?php esc_html_e("Not right file type", 'backup-backup'); ?></div>
        </div>
      </div>

      <div class="center f19 regular mbl lh30">
        <?php esc_html_e("The file you tried to upload isn't a zip-file.", 'backup-backup'); ?><br>
        <?php esc_html_e("All backup files are saved as zip.", 'backup-backup'); ?>
      </div>
