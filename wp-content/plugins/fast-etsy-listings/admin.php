...
function fu_etsy_admin_init()
{
  ...
  add_settings_section(
    ...
    {
      echo "<p>";
      echo wp_kses_post(__("If you are signed up to the Etsy affiliate scheme at AWin or Rakuten and wish to monetize your Etsy links, fill in your details here.", "fast-etsy-listings"));
      echo "</p>";
    },
  ...
  add_settings_field(
      'fuEtsyAdvertiserID',
      __('AWin or Rakuten Advertiser ID', "fast-etsy-listings"),
      function ($args) { fu_inc_addformselect_dict($args, fuEtsyAffiliateAdvertisers::$Labels); },
      'fu_etsy_options_affiliate',
      'fu_etsy_settings_section_affiliate',
      array(
          'id' => 'fuEtsyAdvertiserID',
          'label' => __('The AWin or Rakuten Advertiser ID', "fast-etsy-listings"),
  ...
  add_settings_field(
      'fuEtsyAffiliateID',
      __('AWin or Rakuten Affiliate Account ID', "fast-etsy-listings"),
      'fu_inc_definput_callback',
      'fu_etsy_options_affiliate',
      'fu_etsy_settings_section_affiliate',
      array(
          'id' => 'fuEtsyAffiliateID',
          'label' => __('Your AWin (6-digit code) or Rakuten Affiliate Account ID (11-character code)', "fast-etsy-listings"),
  ...
  add_settings_field(
      ...
      __('Default AWin or Rakuten Click Reference ID', "fast-etsy-listings"),
      'fu_inc_definput_callback',
      'fu_etsy_options_affiliate',
      'fu_etsy_settings_section_affiliate',
      array(
          'id' => 'fuEtsyAffiliateRefID',
          'label' => __('Default click reference ID to aid reporting in AWin or Rakuten.', "fast-etsy-listings"),
          'readonly' => $g_fuEtsySubInfoApiCall->getRespSuccess() && !$g_fuEtsySubInfoApiCall->isSubscriber(),
          )
    );         
