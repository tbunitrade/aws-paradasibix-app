...
class AboutDriveThemes extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(AboutDriveThemes::class, 'ForminatorGoogleAddon\\Google_Service_Drive_AboutDriveThemes');