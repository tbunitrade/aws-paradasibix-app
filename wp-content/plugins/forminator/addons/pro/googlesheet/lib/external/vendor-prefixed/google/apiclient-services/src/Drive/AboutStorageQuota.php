...
class AboutStorageQuota extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(AboutStorageQuota::class, 'ForminatorGoogleAddon\\Google_Service_Drive_AboutStorageQuota');