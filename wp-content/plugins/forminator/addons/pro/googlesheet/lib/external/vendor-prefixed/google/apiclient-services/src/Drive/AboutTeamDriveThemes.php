...
class AboutTeamDriveThemes extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(AboutTeamDriveThemes::class, 'ForminatorGoogleAddon\\Google_Service_Drive_AboutTeamDriveThemes');