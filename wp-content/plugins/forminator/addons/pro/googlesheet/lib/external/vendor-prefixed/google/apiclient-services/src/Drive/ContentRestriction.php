...
class ContentRestriction extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(ContentRestriction::class, 'ForminatorGoogleAddon\\Google_Service_Drive_ContentRestriction');