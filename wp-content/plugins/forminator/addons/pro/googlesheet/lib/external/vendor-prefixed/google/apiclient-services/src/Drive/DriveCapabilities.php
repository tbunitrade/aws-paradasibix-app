...
class DriveCapabilities extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(DriveCapabilities::class, 'ForminatorGoogleAddon\\Google_Service_Drive_DriveCapabilities');