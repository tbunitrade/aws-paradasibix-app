...
class DriveFileCapabilities extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(DriveFileCapabilities::class, 'ForminatorGoogleAddon\\Google_Service_Drive_DriveFileCapabilities');