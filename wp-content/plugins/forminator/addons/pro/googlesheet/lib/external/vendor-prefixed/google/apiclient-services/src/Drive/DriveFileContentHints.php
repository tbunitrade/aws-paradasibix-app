...
class DriveFileContentHints extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(DriveFileContentHints::class, 'ForminatorGoogleAddon\\Google_Service_Drive_DriveFileContentHints');