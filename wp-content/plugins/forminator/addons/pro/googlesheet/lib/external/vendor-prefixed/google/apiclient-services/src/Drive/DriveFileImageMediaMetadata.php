...
class DriveFileImageMediaMetadata extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var float
     */
...
\class_alias(DriveFileImageMediaMetadata::class, 'ForminatorGoogleAddon\\Google_Service_Drive_DriveFileImageMediaMetadata');