...
class DriveFileLinkShareMetadata extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(DriveFileLinkShareMetadata::class, 'ForminatorGoogleAddon\\Google_Service_Drive_DriveFileLinkShareMetadata');