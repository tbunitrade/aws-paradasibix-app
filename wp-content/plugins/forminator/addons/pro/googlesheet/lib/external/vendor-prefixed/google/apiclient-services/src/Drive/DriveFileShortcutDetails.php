...
class DriveFileShortcutDetails extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(DriveFileShortcutDetails::class, 'ForminatorGoogleAddon\\Google_Service_Drive_DriveFileShortcutDetails');