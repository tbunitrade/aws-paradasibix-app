...
class DriveRestrictions extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(DriveRestrictions::class, 'ForminatorGoogleAddon\\Google_Service_Drive_DriveRestrictions');