...
class LabelFieldModification extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(LabelFieldModification::class, 'ForminatorGoogleAddon\\Google_Service_Drive_LabelFieldModification');