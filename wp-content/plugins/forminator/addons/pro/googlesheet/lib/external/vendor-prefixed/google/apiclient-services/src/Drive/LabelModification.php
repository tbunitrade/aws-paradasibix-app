...
class LabelModification extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(LabelModification::class, 'ForminatorGoogleAddon\\Google_Service_Drive_LabelModification');