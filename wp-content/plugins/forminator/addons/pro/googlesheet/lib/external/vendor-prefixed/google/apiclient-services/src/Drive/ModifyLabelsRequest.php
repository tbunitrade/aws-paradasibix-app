...
class ModifyLabelsRequest extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(ModifyLabelsRequest::class, 'ForminatorGoogleAddon\\Google_Service_Drive_ModifyLabelsRequest');