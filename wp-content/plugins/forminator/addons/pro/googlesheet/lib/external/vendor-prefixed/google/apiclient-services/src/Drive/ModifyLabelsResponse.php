...
class ModifyLabelsResponse extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(ModifyLabelsResponse::class, 'ForminatorGoogleAddon\\Google_Service_Drive_ModifyLabelsResponse');