...
class PermissionTeamDrivePermissionDetails extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(PermissionTeamDrivePermissionDetails::class, 'ForminatorGoogleAddon\\Google_Service_Drive_PermissionTeamDrivePermissionDetails');