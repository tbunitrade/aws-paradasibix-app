 ...
 *  </code>
 */
class Channels extends \ForminatorGoogleAddon\Google\Service\Resource
{
    /**
...
\class_alias(Channels::class, 'ForminatorGoogleAddon\\Google_Service_Drive_Resource_Channels');