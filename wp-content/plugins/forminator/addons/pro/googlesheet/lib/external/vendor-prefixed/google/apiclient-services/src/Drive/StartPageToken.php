...
class StartPageToken extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(StartPageToken::class, 'ForminatorGoogleAddon\\Google_Service_Drive_StartPageToken');