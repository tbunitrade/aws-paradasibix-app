...
class TeamDriveCapabilities extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(TeamDriveCapabilities::class, 'ForminatorGoogleAddon\\Google_Service_Drive_TeamDriveCapabilities');