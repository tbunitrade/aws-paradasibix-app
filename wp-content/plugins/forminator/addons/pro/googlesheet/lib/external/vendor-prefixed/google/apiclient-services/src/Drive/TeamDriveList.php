...
class TeamDriveList extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(TeamDriveList::class, 'ForminatorGoogleAddon\\Google_Service_Drive_TeamDriveList');