...
class TeamDriveRestrictions extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(TeamDriveRestrictions::class, 'ForminatorGoogleAddon\\Google_Service_Drive_TeamDriveRestrictions');