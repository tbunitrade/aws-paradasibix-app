...
class AddDataSourceResponse extends \ForminatorGoogleAddon\Google\Model
{
...
\class_alias(AddDataSourceResponse::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_AddDataSourceResponse');