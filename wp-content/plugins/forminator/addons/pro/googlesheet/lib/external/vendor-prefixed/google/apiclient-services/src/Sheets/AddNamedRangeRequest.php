...
class AddNamedRangeRequest extends \ForminatorGoogleAddon\Google\Model
{
...
\class_alias(AddNamedRangeRequest::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_AddNamedRangeRequest');