...
class AddNamedRangeResponse extends \ForminatorGoogleAddon\Google\Model
{
...
\class_alias(AddNamedRangeResponse::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_AddNamedRangeResponse');