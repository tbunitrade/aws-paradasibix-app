...
class AutoFillRequest extends \ForminatorGoogleAddon\Google\Model
{
...
\class_alias(AutoFillRequest::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_AutoFillRequest');