...
class BandingProperties extends \ForminatorGoogleAddon\Google\Model
{
...
\class_alias(BandingProperties::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_BandingProperties');