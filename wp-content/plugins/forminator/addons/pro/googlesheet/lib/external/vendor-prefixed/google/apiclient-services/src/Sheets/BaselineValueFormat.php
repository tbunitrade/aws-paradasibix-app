...
class BaselineValueFormat extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(BaselineValueFormat::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_BaselineValueFormat');