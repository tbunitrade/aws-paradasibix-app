...
class BasicChartSeries extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(BasicChartSeries::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_BasicChartSeries');