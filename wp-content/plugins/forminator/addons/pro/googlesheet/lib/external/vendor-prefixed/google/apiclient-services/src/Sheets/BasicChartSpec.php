...
class BasicChartSpec extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(BasicChartSpec::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_BasicChartSpec');