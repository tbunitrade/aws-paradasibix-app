...
class BasicFilter extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(BasicFilter::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_BasicFilter');