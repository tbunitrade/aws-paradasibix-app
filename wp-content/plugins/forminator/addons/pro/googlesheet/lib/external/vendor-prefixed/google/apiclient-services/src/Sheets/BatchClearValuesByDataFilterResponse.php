...
class BatchClearValuesByDataFilterResponse extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(BatchClearValuesByDataFilterResponse::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_BatchClearValuesByDataFilterResponse');