...
class BatchClearValuesResponse extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(BatchClearValuesResponse::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_BatchClearValuesResponse');