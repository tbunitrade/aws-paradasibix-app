...
class BatchGetValuesByDataFilterResponse extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(BatchGetValuesByDataFilterResponse::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_BatchGetValuesByDataFilterResponse');