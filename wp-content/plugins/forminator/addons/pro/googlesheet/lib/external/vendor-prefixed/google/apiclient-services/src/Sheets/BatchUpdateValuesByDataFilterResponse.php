...
class BatchUpdateValuesByDataFilterResponse extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(BatchUpdateValuesByDataFilterResponse::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_BatchUpdateValuesByDataFilterResponse');