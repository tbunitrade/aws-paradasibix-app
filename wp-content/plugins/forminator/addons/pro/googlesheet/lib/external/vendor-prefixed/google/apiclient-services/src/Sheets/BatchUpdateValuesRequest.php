...
class BatchUpdateValuesRequest extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(BatchUpdateValuesRequest::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_BatchUpdateValuesRequest');