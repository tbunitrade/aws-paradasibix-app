...
class BigQueryDataSourceSpec extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(BigQueryDataSourceSpec::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_BigQueryDataSourceSpec');