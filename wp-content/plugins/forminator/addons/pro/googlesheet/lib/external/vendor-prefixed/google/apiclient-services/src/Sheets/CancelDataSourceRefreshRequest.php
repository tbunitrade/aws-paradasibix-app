...
class CancelDataSourceRefreshRequest extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(CancelDataSourceRefreshRequest::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_CancelDataSourceRefreshRequest');