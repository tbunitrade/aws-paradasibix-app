...
class CancelDataSourceRefreshStatus extends \ForminatorGoogleAddon\Google\Model
{
...
\class_alias(CancelDataSourceRefreshStatus::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_CancelDataSourceRefreshStatus');