...
class CandlestickChartSpec extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(CandlestickChartSpec::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_CandlestickChartSpec');