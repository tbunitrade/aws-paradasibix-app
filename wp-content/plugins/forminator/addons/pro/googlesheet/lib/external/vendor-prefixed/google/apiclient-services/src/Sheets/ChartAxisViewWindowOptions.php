...
class ChartAxisViewWindowOptions extends \ForminatorGoogleAddon\Google\Model
{
...
\class_alias(ChartAxisViewWindowOptions::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_ChartAxisViewWindowOptions');