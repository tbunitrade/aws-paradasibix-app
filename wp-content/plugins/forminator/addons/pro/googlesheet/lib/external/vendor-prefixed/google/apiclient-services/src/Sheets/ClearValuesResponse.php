...
class ClearValuesResponse extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ClearValuesResponse::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_ClearValuesResponse');