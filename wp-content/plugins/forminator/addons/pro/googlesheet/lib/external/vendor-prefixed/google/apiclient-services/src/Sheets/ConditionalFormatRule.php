...
class ConditionalFormatRule extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(ConditionalFormatRule::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_ConditionalFormatRule');