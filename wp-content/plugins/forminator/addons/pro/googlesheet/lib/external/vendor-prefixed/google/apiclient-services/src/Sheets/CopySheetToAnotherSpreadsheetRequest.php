...
class CopySheetToAnotherSpreadsheetRequest extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(CopySheetToAnotherSpreadsheetRequest::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_CopySheetToAnotherSpreadsheetRequest');