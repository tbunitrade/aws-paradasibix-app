...
class CreateDeveloperMetadataRequest extends \ForminatorGoogleAddon\Google\Model
{
...
\class_alias(CreateDeveloperMetadataRequest::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_CreateDeveloperMetadataRequest');