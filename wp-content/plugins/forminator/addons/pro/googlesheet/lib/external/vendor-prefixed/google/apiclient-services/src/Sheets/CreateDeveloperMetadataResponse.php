...
class CreateDeveloperMetadataResponse extends \ForminatorGoogleAddon\Google\Model
{
...
\class_alias(CreateDeveloperMetadataResponse::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_CreateDeveloperMetadataResponse');