...
class DataFilterValueRange extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(DataFilterValueRange::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_DataFilterValueRange');