...
class DataSourceFormula extends \ForminatorGoogleAddon\Google\Model
{
...
\class_alias(DataSourceFormula::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_DataSourceFormula');