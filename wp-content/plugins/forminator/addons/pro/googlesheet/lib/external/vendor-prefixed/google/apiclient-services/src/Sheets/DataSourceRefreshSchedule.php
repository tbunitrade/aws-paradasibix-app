...
class DataSourceRefreshSchedule extends \ForminatorGoogleAddon\Google\Model
{
...
\class_alias(DataSourceRefreshSchedule::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_DataSourceRefreshSchedule');