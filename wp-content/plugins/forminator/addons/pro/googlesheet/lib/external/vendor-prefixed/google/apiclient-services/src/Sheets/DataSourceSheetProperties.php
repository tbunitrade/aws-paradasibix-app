...
class DataSourceSheetProperties extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(DataSourceSheetProperties::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_DataSourceSheetProperties');