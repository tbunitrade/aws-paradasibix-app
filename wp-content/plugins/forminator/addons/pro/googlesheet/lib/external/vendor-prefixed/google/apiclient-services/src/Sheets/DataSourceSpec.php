...
class DataSourceSpec extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(DataSourceSpec::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_DataSourceSpec');