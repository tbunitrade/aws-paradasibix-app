...
class DataSourceTable extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(DataSourceTable::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_DataSourceTable');