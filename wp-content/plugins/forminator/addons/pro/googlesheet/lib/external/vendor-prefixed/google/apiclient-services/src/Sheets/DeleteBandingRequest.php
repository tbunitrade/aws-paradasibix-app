...
class DeleteBandingRequest extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(DeleteBandingRequest::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_DeleteBandingRequest');