...
class DeleteDimensionGroupResponse extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(DeleteDimensionGroupResponse::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_DeleteDimensionGroupResponse');