...
class DeleteDuplicatesRequest extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(DeleteDuplicatesRequest::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_DeleteDuplicatesRequest');