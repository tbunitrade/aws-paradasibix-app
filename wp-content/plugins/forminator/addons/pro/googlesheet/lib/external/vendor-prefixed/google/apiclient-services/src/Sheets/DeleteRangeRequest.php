...
class DeleteRangeRequest extends \ForminatorGoogleAddon\Google\Model
{
...
\class_alias(DeleteRangeRequest::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_DeleteRangeRequest');