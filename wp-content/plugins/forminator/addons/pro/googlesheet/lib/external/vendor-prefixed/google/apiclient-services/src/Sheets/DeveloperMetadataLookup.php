...
class DeveloperMetadataLookup extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(DeveloperMetadataLookup::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_DeveloperMetadataLookup');