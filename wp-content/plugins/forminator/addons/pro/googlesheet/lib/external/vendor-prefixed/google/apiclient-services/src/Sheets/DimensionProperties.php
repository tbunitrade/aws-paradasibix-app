...
class DimensionProperties extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(DimensionProperties::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_DimensionProperties');