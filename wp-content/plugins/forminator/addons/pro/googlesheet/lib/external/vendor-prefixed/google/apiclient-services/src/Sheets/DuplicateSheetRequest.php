...
class DuplicateSheetRequest extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(DuplicateSheetRequest::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_DuplicateSheetRequest');