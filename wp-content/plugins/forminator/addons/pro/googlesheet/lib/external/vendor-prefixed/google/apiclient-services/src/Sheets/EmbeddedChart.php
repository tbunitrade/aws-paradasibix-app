...
class EmbeddedChart extends \ForminatorGoogleAddon\Google\Model
{
...
\class_alias(EmbeddedChart::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_EmbeddedChart');