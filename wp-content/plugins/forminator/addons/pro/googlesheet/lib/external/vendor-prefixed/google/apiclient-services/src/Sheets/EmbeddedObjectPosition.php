...
class EmbeddedObjectPosition extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(EmbeddedObjectPosition::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_EmbeddedObjectPosition');