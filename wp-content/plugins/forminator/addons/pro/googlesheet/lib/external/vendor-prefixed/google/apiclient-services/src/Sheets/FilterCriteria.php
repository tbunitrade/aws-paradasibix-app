...
class FilterCriteria extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(FilterCriteria::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_FilterCriteria');