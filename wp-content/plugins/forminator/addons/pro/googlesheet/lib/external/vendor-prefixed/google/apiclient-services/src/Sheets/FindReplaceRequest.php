...
class FindReplaceRequest extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(FindReplaceRequest::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_FindReplaceRequest');