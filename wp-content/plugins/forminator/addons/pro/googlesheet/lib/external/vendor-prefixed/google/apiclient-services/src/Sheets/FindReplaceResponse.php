...
class FindReplaceResponse extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(FindReplaceResponse::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_FindReplaceResponse');