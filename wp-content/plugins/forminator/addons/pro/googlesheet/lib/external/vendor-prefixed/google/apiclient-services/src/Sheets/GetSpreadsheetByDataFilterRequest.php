...
class GetSpreadsheetByDataFilterRequest extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(GetSpreadsheetByDataFilterRequest::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_GetSpreadsheetByDataFilterRequest');