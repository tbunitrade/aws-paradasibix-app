...
class GridProperties extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(GridProperties::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_GridProperties');