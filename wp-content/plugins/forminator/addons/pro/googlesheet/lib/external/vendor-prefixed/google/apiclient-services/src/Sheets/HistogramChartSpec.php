...
class HistogramChartSpec extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(HistogramChartSpec::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_HistogramChartSpec');