...
class InsertDimensionRequest extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var bool
     */
...
\class_alias(InsertDimensionRequest::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_InsertDimensionRequest');