...
class InsertRangeRequest extends \ForminatorGoogleAddon\Google\Model
{
...
\class_alias(InsertRangeRequest::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_InsertRangeRequest');