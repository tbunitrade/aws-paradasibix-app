...
class InterpolationPoint extends \ForminatorGoogleAddon\Google\Model
{
...
\class_alias(InterpolationPoint::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_InterpolationPoint');