...
class IterativeCalculationSettings extends \ForminatorGoogleAddon\Google\Model
{
...
\class_alias(IterativeCalculationSettings::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_IterativeCalculationSettings');