...
class KeyValueFormat extends \ForminatorGoogleAddon\Google\Model
{
...
\class_alias(KeyValueFormat::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_KeyValueFormat');