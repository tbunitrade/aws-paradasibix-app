...
class ManualRuleGroup extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(ManualRuleGroup::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_ManualRuleGroup');