...
class MatchedDeveloperMetadata extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(MatchedDeveloperMetadata::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_MatchedDeveloperMetadata');