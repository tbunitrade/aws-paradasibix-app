...
class MoveDimensionRequest extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(MoveDimensionRequest::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_MoveDimensionRequest');