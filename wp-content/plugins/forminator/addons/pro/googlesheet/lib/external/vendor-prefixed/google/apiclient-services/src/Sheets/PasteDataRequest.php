...
class PasteDataRequest extends \ForminatorGoogleAddon\Google\Model
{
...
\class_alias(PasteDataRequest::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_PasteDataRequest');