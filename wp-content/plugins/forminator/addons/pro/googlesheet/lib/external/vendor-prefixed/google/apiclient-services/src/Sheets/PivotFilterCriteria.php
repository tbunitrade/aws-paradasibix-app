...
class PivotFilterCriteria extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(PivotFilterCriteria::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_PivotFilterCriteria');