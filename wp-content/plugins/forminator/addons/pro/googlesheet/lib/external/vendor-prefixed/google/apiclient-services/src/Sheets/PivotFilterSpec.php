...
class PivotFilterSpec extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(PivotFilterSpec::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_PivotFilterSpec');