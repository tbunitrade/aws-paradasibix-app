...
class PivotGroupLimit extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(PivotGroupLimit::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_PivotGroupLimit');