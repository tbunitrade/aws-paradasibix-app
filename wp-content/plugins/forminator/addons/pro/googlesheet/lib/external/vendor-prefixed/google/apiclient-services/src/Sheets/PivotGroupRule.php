...
class PivotGroupRule extends \ForminatorGoogleAddon\Google\Model
{
...
\class_alias(PivotGroupRule::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_PivotGroupRule');