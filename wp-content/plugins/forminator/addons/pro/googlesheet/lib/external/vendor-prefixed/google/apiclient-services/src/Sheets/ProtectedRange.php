...
class ProtectedRange extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(ProtectedRange::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_ProtectedRange');