...
class RefreshDataSourceResponse extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(RefreshDataSourceResponse::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_RefreshDataSourceResponse');