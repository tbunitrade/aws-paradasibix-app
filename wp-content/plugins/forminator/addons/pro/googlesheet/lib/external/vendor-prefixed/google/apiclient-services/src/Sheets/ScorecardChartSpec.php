...
class ScorecardChartSpec extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(ScorecardChartSpec::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_ScorecardChartSpec');