...
class SearchDeveloperMetadataResponse extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(SearchDeveloperMetadataResponse::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_SearchDeveloperMetadataResponse');