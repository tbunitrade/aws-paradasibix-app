...
class SheetProperties extends \ForminatorGoogleAddon\Google\Model
{
...
\class_alias(SheetProperties::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_SheetProperties');