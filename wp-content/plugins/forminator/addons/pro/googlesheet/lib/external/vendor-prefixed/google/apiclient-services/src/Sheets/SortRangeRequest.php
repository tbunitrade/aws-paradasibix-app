...
class SortRangeRequest extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(SortRangeRequest::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_SortRangeRequest');