...
class TextToColumnsRequest extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(TextToColumnsRequest::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_TextToColumnsRequest');