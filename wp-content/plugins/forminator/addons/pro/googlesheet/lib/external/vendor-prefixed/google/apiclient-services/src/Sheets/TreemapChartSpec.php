...
class TreemapChartSpec extends \ForminatorGoogleAddon\Google\Model
{
...
\class_alias(TreemapChartSpec::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_TreemapChartSpec');