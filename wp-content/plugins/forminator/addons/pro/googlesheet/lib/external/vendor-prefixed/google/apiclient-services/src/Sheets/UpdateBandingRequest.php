...
class UpdateBandingRequest extends \ForminatorGoogleAddon\Google\Model
{
...
\class_alias(UpdateBandingRequest::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_UpdateBandingRequest');