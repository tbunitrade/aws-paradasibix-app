...
class UpdateBordersRequest extends \ForminatorGoogleAddon\Google\Model
{
...
\class_alias(UpdateBordersRequest::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_UpdateBordersRequest');