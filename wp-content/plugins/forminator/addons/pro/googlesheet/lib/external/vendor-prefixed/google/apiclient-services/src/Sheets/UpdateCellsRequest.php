...
class UpdateCellsRequest extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(UpdateCellsRequest::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_UpdateCellsRequest');