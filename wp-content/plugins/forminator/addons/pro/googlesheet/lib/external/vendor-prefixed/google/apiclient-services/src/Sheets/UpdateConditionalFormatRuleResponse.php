...
class UpdateConditionalFormatRuleResponse extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var int
     */
...
\class_alias(UpdateConditionalFormatRuleResponse::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_UpdateConditionalFormatRuleResponse');