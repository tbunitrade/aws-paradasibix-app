...
class UpdateDimensionGroupRequest extends \ForminatorGoogleAddon\Google\Model
{
...
\class_alias(UpdateDimensionGroupRequest::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_UpdateDimensionGroupRequest');