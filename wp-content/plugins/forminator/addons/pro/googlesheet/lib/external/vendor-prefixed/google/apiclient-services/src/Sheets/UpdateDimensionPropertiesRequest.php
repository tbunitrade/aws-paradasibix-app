...
class UpdateDimensionPropertiesRequest extends \ForminatorGoogleAddon\Google\Model
{
...
\class_alias(UpdateDimensionPropertiesRequest::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_UpdateDimensionPropertiesRequest');