...
class UpdateEmbeddedObjectBorderRequest extends \ForminatorGoogleAddon\Google\Model
{
...
\class_alias(UpdateEmbeddedObjectBorderRequest::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_UpdateEmbeddedObjectBorderRequest');