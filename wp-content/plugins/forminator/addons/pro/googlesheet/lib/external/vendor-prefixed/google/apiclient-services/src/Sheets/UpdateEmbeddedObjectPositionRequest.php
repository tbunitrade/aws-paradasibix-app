...
class UpdateEmbeddedObjectPositionRequest extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UpdateEmbeddedObjectPositionRequest::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_UpdateEmbeddedObjectPositionRequest');