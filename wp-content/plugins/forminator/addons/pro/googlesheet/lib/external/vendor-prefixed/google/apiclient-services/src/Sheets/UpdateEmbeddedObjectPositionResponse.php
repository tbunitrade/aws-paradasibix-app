...
class UpdateEmbeddedObjectPositionResponse extends \ForminatorGoogleAddon\Google\Model
{
...
\class_alias(UpdateEmbeddedObjectPositionResponse::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_UpdateEmbeddedObjectPositionResponse');