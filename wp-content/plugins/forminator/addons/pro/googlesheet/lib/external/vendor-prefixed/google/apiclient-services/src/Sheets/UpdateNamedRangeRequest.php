...
class UpdateNamedRangeRequest extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UpdateNamedRangeRequest::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_UpdateNamedRangeRequest');