...
class UpdateProtectedRangeRequest extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UpdateProtectedRangeRequest::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_UpdateProtectedRangeRequest');