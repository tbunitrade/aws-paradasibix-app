...
class UpdateSpreadsheetPropertiesRequest extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UpdateSpreadsheetPropertiesRequest::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_UpdateSpreadsheetPropertiesRequest');