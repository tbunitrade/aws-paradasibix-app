...
class UpdateValuesByDataFilterResponse extends \ForminatorGoogleAddon\Google\Model
{
...
\class_alias(UpdateValuesByDataFilterResponse::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_UpdateValuesByDataFilterResponse');