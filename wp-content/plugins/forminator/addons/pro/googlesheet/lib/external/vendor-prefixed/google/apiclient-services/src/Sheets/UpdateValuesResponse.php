...
class UpdateValuesResponse extends \ForminatorGoogleAddon\Google\Model
{
    /**
     * @var string
     */
...
\class_alias(UpdateValuesResponse::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_UpdateValuesResponse');