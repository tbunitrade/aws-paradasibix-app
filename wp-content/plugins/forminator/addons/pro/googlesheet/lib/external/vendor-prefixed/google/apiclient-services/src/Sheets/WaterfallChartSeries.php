...
class WaterfallChartSeries extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(WaterfallChartSeries::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_WaterfallChartSeries');