...
class WaterfallChartSpec extends \ForminatorGoogleAddon\Google\Collection
{
...
\class_alias(WaterfallChartSpec::class, 'ForminatorGoogleAddon\\Google_Service_Sheets_WaterfallChartSpec');