 ...
 */
namespace ForminatorGoogleAddon\Google;

use BadMethodCallException;
use DomainException;
use ForminatorGoogleAddon\Google\AccessToken\Revoke;
use ForminatorGoogleAddon\Google\AccessToken\Verify;
use ForminatorGoogleAddon\Google\Auth\ApplicationDefaultCredentials;
use ForminatorGoogleAddon\Google\Auth\Cache\MemoryCacheItemPool;
use ForminatorGoogleAddon\Google\Auth\Credentials\ServiceAccountCredentials;
use ForminatorGoogleAddon\Google\Auth\Credentials\UserRefreshCredentials;
use ForminatorGoogleAddon\Google\Auth\CredentialsLoader;
use ForminatorGoogleAddon\Google\Auth\FetchAuthTokenCache;
use ForminatorGoogleAddon\Google\Auth\GetUniverseDomainInterface;
use ForminatorGoogleAddon\Google\Auth\HttpHandler\HttpHandlerFactory;
use ForminatorGoogleAddon\Google\Auth\OAuth2;
use ForminatorGoogleAddon\Google\AuthHandler\AuthHandlerFactory;
use ForminatorGoogleAddon\Google\Http\REST;
use ForminatorGoogleAddon\GuzzleHttp\Client as GuzzleClient;
use ForminatorGoogleAddon\GuzzleHttp\ClientInterface;
use ForminatorGoogleAddon\GuzzleHttp\Ring\Client\StreamHandler;
use InvalidArgumentException;
use LogicException;
use ForminatorGoogleAddon\Monolog\Handler\StreamHandler as MonologStreamHandler;
use ForminatorGoogleAddon\Monolog\Handler\SyslogHandler as MonologSyslogHandler;
use ForminatorGoogleAddon\Monolog\Logger;
...
use ForminatorGoogleAddon\Psr\Log\LoggerInterface;
...
class Client
{
    ...
    {
        $guzzleVersion = null;
        if (\defined('\\ForminatorGoogleAddon\\GuzzleHttp\\ClientInterface::MAJOR_VERSION')) {
            $guzzleVersion = ClientInterface::MAJOR_VERSION;
        } elseif (\defined('\\ForminatorGoogleAddon\\GuzzleHttp\\ClientInterface::VERSION')) {
