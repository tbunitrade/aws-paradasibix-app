 ...
 */
namespace ForminatorGoogleAddon\Google\Http;

use ForminatorGoogleAddon\Google\Auth\HttpHandler\HttpHandlerFactory;
use ForminatorGoogleAddon\Google\Service\Exception as GoogleServiceException;
use ForminatorGoogleAddon\Google\Task\Runner;
use ForminatorGoogleAddon\GuzzleHttp\ClientInterface;
use ForminatorGoogleAddon\GuzzleHttp\Exception\RequestException;
use ForminatorGoogleAddon\GuzzleHttp\Psr7\Response;
...
class REST
{
    ...
    public static function doExecute(ClientInterface $client, RequestInterface $request, $expectedClass = null)
    {
        try {
            ...
            if (\interface_exists('ForminatorGoogleAddon\\GuzzleHttp\\Message\\ResponseInterface') && $response instanceof \ForminatorGoogleAddon\GuzzleHttp\Message\ResponseInterface) {
