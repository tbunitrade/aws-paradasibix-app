 ...
 * the License.
 */
namespace ForminatorGoogleAddon\Google\Task;

use ForminatorGoogleAddon\Composer\Script\Event;
use InvalidArgumentException;
use ForminatorGoogleAddon\Symfony\Component\Filesystem\Filesystem;
use ForminatorGoogleAddon\Symfony\Component\Finder\Finder;
class Composer
{
    /**
