...
use DateTime;
use ForminatorGoogleAddon\Firebase\JWT\ExpiredException;
use ForminatorGoogleAddon\Firebase\JWT\JWT;
use ForminatorGoogleAddon\Firebase\JWT\Key;
use ForminatorGoogleAddon\Firebase\JWT\SignatureInvalidException;
...
use ForminatorGoogleAddon\SimpleJWT\InvalidTokenException;
use ForminatorGoogleAddon\SimpleJWT\JWT as SimpleJWT;
use ForminatorGoogleAddon\SimpleJWT\Keys\KeyFactory;
use ForminatorGoogleAddon\SimpleJWT\Keys\KeySet;
use TypeError;
