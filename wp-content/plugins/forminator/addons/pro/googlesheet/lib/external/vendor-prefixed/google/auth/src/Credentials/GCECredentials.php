...
use ForminatorGoogleAddon\Google\Auth\Iam;
use ForminatorGoogleAddon\Google\Auth\IamSignerTrait;
use ForminatorGoogleAddon\Google\Auth\ProjectIdProviderInterface;
use ForminatorGoogleAddon\Google\Auth\SignBlobInterface;
use ForminatorGoogleAddon\GuzzleHttp\Exception\ClientException;
...
use ForminatorGoogleAddon\GuzzleHttp\Exception\ServerException;
