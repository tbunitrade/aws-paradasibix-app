...
use ForminatorGoogleAddon\Google\Auth\Credentials\ExternalAccountCredentials;
use ForminatorGoogleAddon\Google\Auth\Credentials\ImpersonatedServiceAccountCredentials;
use ForminatorGoogleAddon\Google\Auth\Credentials\InsecureCredentials;
...
abstract class CredentialsLoader implements GetUniverseDomainInterface, FetchAuthTokenInterface, UpdateMetadataInterface
{
    ...
    public static function makeHttpClient(FetchAuthTokenInterface $fetcher, array $httpClientOptions = [], callable $httpHandler = null, callable $tokenCallback = null)
    {
        ...
        $stack = \ForminatorGoogleAddon\GuzzleHttp\HandlerStack::create();
        $stack->push($middleware);
        return new \ForminatorGoogleAddon\GuzzleHttp\Client(['handler' => $stack, 'auth' => 'google_auth'] + $httpClientOptions);
    }
    /**
