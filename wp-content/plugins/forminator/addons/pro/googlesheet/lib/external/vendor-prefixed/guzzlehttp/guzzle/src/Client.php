...
use ForminatorGoogleAddon\GuzzleHttp\Cookie\CookieJar;
use ForminatorGoogleAddon\GuzzleHttp\Exception\GuzzleException;
use ForminatorGoogleAddon\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \ForminatorGoogleAddon\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
