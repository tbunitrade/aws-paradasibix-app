...
use ForminatorGoogleAddon\Monolog\Formatter\JsonFormatter;
use ForminatorGoogleAddon\PhpAmqpLib\Message\AMQPMessage;
use ForminatorGoogleAddon\PhpAmqpLib\Channel\AMQPChannel;
use AMQPExchange;
/**
