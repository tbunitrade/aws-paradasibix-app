...
use ForminatorGoogleAddon\Elastica\Document;
use ForminatorGoogleAddon\Monolog\Formatter\FormatterInterface;
use ForminatorGoogleAddon\Monolog\Formatter\ElasticaFormatter;
use ForminatorGoogleAddon\Monolog\Logger;
use ForminatorGoogleAddon\Elastica\Client;
use ForminatorGoogleAddon\Elastica\Exception\ExceptionInterface;
/**
