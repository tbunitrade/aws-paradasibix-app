...
use ForminatorGoogleAddon\Elastic\Elasticsearch\Response\Elasticsearch;
use Throwable;
use RuntimeException;
use ForminatorGoogleAddon\Monolog\Logger;
use ForminatorGoogleAddon\Monolog\Formatter\FormatterInterface;
use ForminatorGoogleAddon\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use ForminatorGoogleAddon\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use ForminatorGoogleAddon\Elasticsearch\Client;
use ForminatorGoogleAddon\Elastic\Elasticsearch\Exception\InvalidArgumentException as ElasticInvalidArgumentException;
use ForminatorGoogleAddon\Elastic\Elasticsearch\Client as Client8;
/**
