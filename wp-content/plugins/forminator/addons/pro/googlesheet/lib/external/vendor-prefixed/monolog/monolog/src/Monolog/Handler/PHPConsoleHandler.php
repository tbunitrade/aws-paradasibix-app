...
use ForminatorGoogleAddon\Monolog\Formatter\LineFormatter;
use ForminatorGoogleAddon\Monolog\Formatter\FormatterInterface;
use ForminatorGoogleAddon\Monolog\Logger;
use ForminatorGoogleAddon\Monolog\Utils;
use ForminatorGoogleAddon\PhpConsole\Connector;
use ForminatorGoogleAddon\PhpConsole\Handler as VendorPhpConsoleHandler;
use ForminatorGoogleAddon\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!\class_exists('ForminatorGoogleAddon\\PhpConsole\\Connector')) {
