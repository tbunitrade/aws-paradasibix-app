...
use ForminatorGoogleAddon\Swift_Message;
use ForminatorGoogleAddon\Swift;
/**
...
class SwiftMailerHandler extends MailHandler
{
     ...
     */
    public function __construct(\ForminatorGoogleAddon\Swift_Mailer $mailer, $message, $level = Logger::ERROR, bool $bubble = \true)
    {
