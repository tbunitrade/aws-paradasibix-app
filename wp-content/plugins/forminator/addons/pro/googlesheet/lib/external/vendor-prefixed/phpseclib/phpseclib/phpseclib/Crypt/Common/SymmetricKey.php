 ...
 */
namespace ForminatorGoogleAddon\phpseclib3\Crypt\Common;
...
use ForminatorGoogleAddon\phpseclib3\Exception\BadDecryptionException;
use ForminatorGoogleAddon\phpseclib3\Exception\BadModeException;
use ForminatorGoogleAddon\phpseclib3\Exception\InconsistentSetupException;
...
use ForminatorGoogleAddon\phpseclib3\Math\BinaryField;
use ForminatorGoogleAddon\phpseclib3\Math\PrimeField;
/**
 * Base Class for all \phpseclib3\Crypt\* cipher classes
 *
 * @author  Jim Wigginton <terrafrost@php.net>
