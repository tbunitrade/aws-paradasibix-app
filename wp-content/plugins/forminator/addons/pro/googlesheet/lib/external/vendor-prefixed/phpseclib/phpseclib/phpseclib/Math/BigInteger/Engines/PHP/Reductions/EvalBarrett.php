 ...
 */
namespace ForminatorGoogleAddon\phpseclib3\Math\BigInteger\Engines\PHP\Reductions;

use ForminatorGoogleAddon\phpseclib3\Math\BigInteger\Engines\PHP;
use ForminatorGoogleAddon\phpseclib3\Math\BigInteger\Engines\PHP\Base;
/**
 * PHP Dynamic Barrett Modular Exponentiation Engine
 *
 * @author  Jim Wigginton <terrafrost@php.net>
