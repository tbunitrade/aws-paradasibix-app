...
namespace ForminatorGoogleAddon\Psr\Log\Test;

use ForminatorGoogleAddon\Psr\Log\LoggerInterface;
use ForminatorGoogleAddon\Psr\Log\LogLevel;
use ForminatorGoogleAddon\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('ForminatorGoogleAddon\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('ForminatorGoogleAddon\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('ForminatorGoogleAddon\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
