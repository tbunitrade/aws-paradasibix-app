...
"Select" => array( null, __("Select", "forminator"), ), // src/settings/inputs/uploads.js:39
...
"Section Title" => array( null, __("Section Title", "forminator"), ), // src/settings/inputs/ace-editor.js:84
"Section Subtitle" => array( null, __("Section Subtitle", "forminator"), ), // src/settings/inputs/ace-editor.js:91
"Field Label" => array( null, __("Field Label", "forminator"), ), // src/settings/inputs/ace-editor.js:98
...
"Question" => array( null, __("Question", "forminator"), ), // src/settings/inputs/ace-editor.js:137
...
"Submit Button" => array( null, __("Submit Button", "forminator"), ), // src/settings/inputs/ace-editor.js:152
"View Results Link" => array( null, __("View Results Link", "forminator"), ), // src/settings/inputs/ace-editor.js:160
"Quiz" => array( null, __("Quiz", "forminator"), ), // src/settings/inputs/ace-editor.js:173
"Title" => array( null, __("Title", "forminator"), ), // src/settings/inputs/ace-editor.js:178
"Description" => array( null, __("Description", "forminator"), ), // src/settings/inputs/ace-editor.js:183
...
"Body" => array( null, __("Body", "forminator"), ), // src/settings/inputs/ace-editor.js:213
"PDF Header" => array( null, __("PDF Header", "forminator"), ), // src/settings/inputs/ace-editor.js:220
"Logo" => array( null, __("Logo", "forminator"), ), // src/settings/inputs/ace-editor.js:227
...
"Pagination" => array( null, __("Pagination", "forminator"), ), // src/settings/inputs/ace-editor.js:266
"Learn more about using custom CSS in your PDF file {{link}}here{{/link}}." => array( null, __("Learn more about using custom CSS in your PDF file {{link}}here{{/link}}.", "forminator"), ), // src/settings/inputs/ace-editor.js:287
...
"Sorry, you are not allowed to access this page." => array( null, __("Sorry, you are not allowed to access this page.", "forminator"), ), // src/form/containers/main.js:200
"Back" => array( null, __("Back", "forminator"), ), // src/form/containers/main.js:295
...
"User’s Geolocation" => array( null, __("User’s Geolocation", "forminator"), ), // src/form/components/settings.js:91
...
"Enable current user’s Geolocation" => array( null, __("Enable current user’s Geolocation", "forminator"), ), // src/form/components/settings.js:101
"Enable the checkbox to make it mandatory for users to grant access to the location permission to submit this form." => array( null, __("Enable the checkbox to make it mandatory for users to grant access to the location permission to submit this form.", "forminator"), ), // src/form/components/settings.js:106
"Require access to users' location" => array( null, __("Require access to users' location", "forminator"), ), // src/form/components/settings.js:110
"Error message" => array( null, __("Error message", "forminator"), ), // src/form/components/settings.js:116
"Enter message" => array( null, __("Enter message", "forminator"), ), // src/form/components/settings.js:117
"Multiple Option Value" => array( null, __("Multiple Option Value", "forminator"), ), // src/form/components/settings.js:127
...
"Default Stored Value" => array( null, __("Default Stored Value", "forminator"), ), // src/form/components/settings.js:139
...
"Option labels" => array( null, __("Option labels", "forminator"), ), // src/form/components/settings.js:158
"Option values" => array( null, __("Option values", "forminator"), ), // src/form/components/settings.js:160
"Email Image Options" => array( null, __("Email Image Options", "forminator"), ), // src/form/components/settings.js:169
"Choose how images are shown in email notifications. You can embed images directly in the email or display them as clickable links." => array( null, __("Choose how images are shown in email notifications. You can embed images directly in the email or display them as clickable links.", "forminator"), ), // src/form/components/settings.js:173
"Image Link" => array( null, __("Image Link", "forminator"), ), // src/form/components/settings.js:185
"This setting applies to images from E-Signature and File Upload fields." => array( null, __("This setting applies to images from E-Signature and File Upload fields.", "forminator"), ), // src/form/components/settings.js:200
"Image Preview" => array( null, __("Image Preview", "forminator"), ), // src/form/components/settings.js:207
"This setting applies to images from E-Signature, File Upload, Radio, and Checkbox fields." => array( null, __("This setting applies to images from E-Signature, File Upload, Radio, and Checkbox fields.", "forminator"), ), // src/form/components/settings.js:222
"Choose how you want to handle this form's data storage." => array( null, __("Choose how you want to handle this form's data storage.", "forminator"), ), // src/form/components/settings.js:240
"By default we will use the configuration you have set in your" => array( null, __("By default we will use the configuration you have set in your", "forminator"), ), // src/form/components/settings.js:245
"How long do you want to retain this form's submissions for?" => array( null, __("How long do you want to retain this form's submissions for?", "forminator"), ), // src/form/components/settings.js:260
"Your default setting value is to keep the submissions" => array( null, __("Your default setting value is to keep the submissions", "forminator"), ), // src/form/components/settings.js:288
"Days" => array( null, __("Days", "forminator"), ), // src/form/components/settings.js:322
"Weeks" => array( null, __("Weeks", "forminator"), ), // src/form/components/settings.js:325
"Months" => array( null, __("Months", "forminator"), ), // src/form/components/settings.js:328
"Years" => array( null, __("Years", "forminator"), ), // src/form/components/settings.js:331
"Account Erasure Requests" => array( null, __("Account Erasure Requests", "forminator"), ), // src/form/components/settings.js:347
"When handling an account erasure request that contains an email associated with a submission, what do you want to do?" => array( null, __("When handling an account erasure request that contains an email associated with a submission, what do you want to do?", "forminator"), ), // src/form/components/settings.js:351
"Your default setting value is to " => array( null, __("Your default setting value is to ", "forminator"), ), // src/form/components/settings.js:381
" the submission." => array( null, __(" the submission.", "forminator"), ), // src/form/components/settings.js:383
"Retain Submissions" => array( null, __("Retain Submissions", "forminator"), ), // src/form/components/settings.js:404
"Remove Submissions" => array( null, __("Remove Submissions", "forminator"), ), // src/form/components/settings.js:407
"Submission Files" => array( null, __("Submission Files", "forminator"), ), // src/form/components/settings.js:416
"If your form has file upload field(s), choose whether to delete the file(s) related to a submission when that submission gets deleted." => array( null, __("If your form has file upload field(s), choose whether to delete the file(s) related to a submission when that submission gets deleted.", "forminator"), ), // src/form/components/settings.js:419
"Keep" => array( null, __("Keep", "forminator"), ), // src/form/components/settings.js:429
"User Registration" => array( null, __("User Registration", "forminator"), ), // src/form/components/registration.js:32
"PDF" => array( null, __("PDF", "forminator"), ), // src/form/components/pdf.js:45
"Pro" => array( null, __("Pro", "forminator"), ), // src/form/components/pdf.js:50
...
"Choose the post type associated with this field." => array( null, __("Choose the post type associated with this field.", "forminator"), ), // src/form/components/fields/postdata.js:253
...
"When a user submits this form, choose what status this post data is." => array( null, __("When a user submits this form, choose what status this post data is.", "forminator"), ), // src/form/components/fields/postdata.js:284
...
"Choose whether to allow single or multiple categories or tags on this post." => array( null, __("Choose whether to allow single or multiple categories or tags on this post.", "forminator"), ), // src/form/components/fields/postdata.js:362
...
"Address" => array( null, __("Address", "forminator"), ), // src/form/components/fields/address.js:27
"Apartment, suite, etc." => array( null, __("Apartment, suite, etc.", "forminator"), ), // src/form/components/fields/address.js:31
"City" => array( null, __("City", "forminator"), ), // src/form/components/fields/address.js:35
"State / Province" => array( null, __("State / Province", "forminator"), ), // src/form/components/fields/address.js:39
"ZIP / Postal code" => array( null, __("ZIP / Postal code", "forminator"), ), // src/form/components/fields/address.js:43
"Country" => array( null, __("Country", "forminator"), ), // src/form/components/fields/address.js:47
"Note: The query parameter's value passed in URL should match with the {{link}}alpha-2 country code{{/link}} of the country you want to pre-populate dynamically." => array( null, __("Note: The query parameter's value passed in URL should match with the {{link}}alpha-2 country code{{/link}} of the country you want to pre-populate dynamically.", "forminator"), ), // src/form/components/fields/address.js:72
"The Autocomplete feature simplifies entering addresses by offering real-time suggestions as you type. This feature requires the Forminator Geolocation Add-on." => array( null, __("The Autocomplete feature simplifies entering addresses by offering real-time suggestions as you type. This feature requires the Forminator Geolocation Add-on.", "forminator"), ), // src/form/components/fields/address.js:263
"Collect your form submitters' location information, and provide address auto-completion using Google Maps API." => array( null, __("Collect your form submitters' location information, and provide address auto-completion using Google Maps API.", "forminator"), ), // src/form/components/fields/address.js:268
...
"Stripe Subscription Add-on is required to use this feature. Install it from the Add-ons page." => array( null, __("Stripe Subscription Add-on is required to use this feature. Install it from the Add-ons page.", "forminator"), ), // src/form/components/fields/stripe/plan-setup.js:32
"Collect recurring/subscription Stripe payments with Forminator Pro on your WordPress sites." => array( null, __("Collect recurring/subscription Stripe payments with Forminator Pro on your WordPress sites.", "forminator"), ), // src/form/components/fields/stripe/plan-setup.js:35
"Subscription" => array( null, __("Subscription", "forminator"), ), // src/form/components/fields/stripe/plan-setup.js:38
...
"Plan" => array( null, __("Plan", "forminator"), ), // src/form/components/fields/stripe/plan-setup.js:56
...
"One Time" => array( null, __("One Time", "forminator"), ), // src/form/components/fields/stripe/plan-setup.js:82
...
"The Slider takes the full-width of its container by default, but you can select a different size below." => array( null, __("The Slider takes the full-width of its container by default, but you can select a different size below.", "forminator"), ), // src/form/components/fields/slider/settings.js:66
...
"Adjust the slider base and the height of the draggable thumb/handle." => array( null, __("Adjust the slider base and the height of the draggable thumb/handle.", "forminator"), ), // src/form/components/fields/slider/settings.js:88
"Slider Handle icon" => array( null, __("Slider Handle icon", "forminator"), ), // src/form/components/fields/slider/settings.js:103
"Choose whether to show an icon on the slider handle." => array( null, __("Choose whether to show an icon on the slider handle.", "forminator"), ), // src/form/components/fields/slider/settings.js:105
...
"Use these fields to display texts (e.g., currency symbols or units of measure) before and after the slider values." => array( null, __("Use these fields to display texts (e.g., currency symbols or units of measure) before and after the slider values.", "forminator"), ), // src/form/components/fields/slider/settings.js:236
...
"Install the {{strong}}Forminator Extension Pack add-on{{/strong}} to enable this feature." => array( null, __("Install the {{strong}}Forminator Extension Pack add-on{{/strong}} to enable this feature.", "forminator"), ), // src/form/components/abandonment/disconnected.js:18
...
"The {{strong}}Forminator Free Extension Pack Add-on{{/strong}} is required to enable this feature. Click the Install button below to install it." => array( null, __("The {{strong}}Forminator Free Extension Pack Add-on{{/strong}} is required to enable this feature. Click the Install button below to install it.", "forminator"), ), // src/form/components/abandonment/disconnected.js:24
"Unlock abandoned form insights to refine your strategy and recover missed leads." => array( null, __("Unlock abandoned form insights to refine your strategy and recover missed leads.", "forminator"), ), // src/form/components/abandonment/disconnected.js:43
);
