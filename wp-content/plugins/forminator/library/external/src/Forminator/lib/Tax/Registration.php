...
namespace Forminator\Stripe\Tax;
 ...
 */
class Registration extends \Forminator\Stripe\ApiResource
{
    ...
    {
        $url = static::classUrl();
        return static::_requestPage($url, \Forminator\Stripe\Collection::class, $params, $opts);
    }
    /**
