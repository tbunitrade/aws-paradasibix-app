...
namespace Forminator\Stripe\V2;
 ...
 */
class Collection extends \Forminator\Stripe\StripeObject implements \Countable, \IteratorAggregate
{
    const OBJECT_NAME = 'list';
    use \Forminator\Stripe\ApiOperations\Request;
    /**
     * @return string the base URL for the given class
     */
    public static function baseUrl()
    {
        return \Forminator\Stripe\Stripe::$apiBase;
    }
    /**
     * @return mixed
     */
    ...
    public function autoPagingIterator()
    {
        ...
        while (\true) {
            ...
            $obj = \Forminator\Stripe\Util\Util::convertToStripeObject($response, $opts, 'v2');
